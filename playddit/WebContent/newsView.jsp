	        ...
	        <jsp:include page="/header.jsp"></jsp:include>
                ...
                <div id="news" class="scrollStyle">
                    <div id="newsDetail">
                        <div id="titleBox">
                            <h3>
                                [3월과정 면접일정] 전자정부 표준 프레임워크 기반 풀-스택 개발자 양성과정(9기)    
                            </h3>
                            <p>
                                21/03/07
                            </p>
                        ...
                        <p>
                            ...
                            대덕인재개발원 입학을 환영합니다~ 열심히 배워서 많은 것을 얻어 가시기 바랍니다! 302호는 엘리베이터를 타면 가기가 어려워요^^ 하나은행 옆에 문으로 들어가서 계단을 올라가야 합니다....테스트를 위해 더길게...
                            띄어쓰기 한것도...다 적용해서 출력 부탁드려요....
                            뉴스...데이터는 언제 넣죠???ㅠㅠㅠㅠㅠ
                            띄어쓰기한거 보고싶어서 강제로 br태그 넣었습니다...
                            <br/><br/>
                            대덕인재개발원 입학을 환영합니다~ 열심히 배워서 많은 것을 얻어 가시기 바랍니다! 302호는 엘리베이터를 타면 가기가 어려워요^^ 하나은행 옆에 문으로 들어가서 계단을 올라가야 합니다....테스트를 위해 더길게...
                            띄어쓰기 한것도...다 적용해서 출력 부탁드려요....
                            뉴스...데이터는 언제 넣죠???ㅠㅠㅠㅠㅠ
